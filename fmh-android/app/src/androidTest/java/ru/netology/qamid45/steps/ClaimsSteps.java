...
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonAddClaim;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonAddComment;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonCancel;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonCancelClaim;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonClaims;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonEditComment;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonFilter;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonMainMenu;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonOk;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonOkDate;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonOkError;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonOkNotification;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonOkTime;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonSave;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonSettings;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsButtonTakeToWork;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsCheckBoxCancelled;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsCheckBoxExecuted;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsCommentField;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsDateField;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsDescriptionField;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsEditClaim;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsExecutorField;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsOpenClaim;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsRemoveCheckBoxInProgress;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsRemoveCheckBoxOpen;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsTimeField;
import static ru.netology.qamid45.elements.ClaimsScreen.getClaimsElementsTitleField;
import static ru.netology.qamid45.elements.WaitId.waitFor;
...
public class ClaimsSteps {
    ...
    public static void clickExecutorFieldConsistsLettersAndNumbers() {
        Allure.step("Ввести в поле Исполнитель буквы русского алфавита и цифры");
        onView(getClaimsElementsExecutorField())
